...
export { ModulesPermissionsService } from './services/modules-permissions.service';
...
export { ConsultationTypesService } from './services/consultation-types.service';
export { InventoryDashboardService } from './services/inventory-dashboard.service';
